...
public class Login_Test_Driver {
    ...
    // correct username, correct password
       ...
       try {
           Assert.assertFalse(quickLaunchpad_page.quickLaunchPadPageTitle.isDisplayed());
...
/*
1- Login with valid credentials. Only authenticated users can access to application (OK)
...
2- Warning Messages, While logging in:
      a) "Invalid username or password." message should be displayed for invalid credentials (OK *3)
        invalid username, valid password (OK)
        valid username, invalid password (OK)
        invalid username, invalid password   (OK)
