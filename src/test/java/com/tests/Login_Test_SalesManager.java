...
public class Login_Test_SalesManager {
...
1- Login with valid credentials. Only authenticated users can access to application (+)
      a) User type "Sales Manager" should land on the "Dashboard" page after login


2- Warning Messages, While logging in:
      a) "Invalid username or password." message should be displayed for invalid credentials (3*+)
